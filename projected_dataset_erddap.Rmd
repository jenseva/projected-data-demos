...
This example works with data provided by ERDDAP with projected coordinates (polar stereographic). For an example of making projected maps of datasets provided in lat-lon coordinates see the projected maps exercise at: https://coastwatch.pfeg.noaa.gov/projects/r/projectedbuoy.html 
...
**Example data download URL from an ERDDAP data access form**   
...
**MAP WITH A POLAR VIEW: 'coord_map' method**
...
**MAP WITH CLIPPED POLAR VIEW: 'coord_polar' method**
...
[Projecting Data from ERDDAP - R Notebook](https://coastwatch.pfeg.noaa.gov/projects/r/projectedbuoy.html) - Access and make projected plots of traditional lat-lon datasets from ERDDAP using R

[ERDDAP Course Book](https://coastwatch.pfeg.noaa.gov/projects/erddap/) - Using the features of ERDDAP

[Using R with ERDDAP Course Book](https://coastwatch.pfeg.noaa.gov/projects/r/) - A collection of R notebooks demonstrating accessing and using ERDDAP datasets in R