...
Here we will map the in-situ data locations using the lat-lon coordinates on a ggplot map
...
Next, let's plot the same float location data again using the OCE package. This plotting package allows us to specify the projection of the map while still using lat-lon coordinates for the float locations.
...
* Plot the projected point data on top of the NOAA sea ice concentration CDR data using ggplot  
