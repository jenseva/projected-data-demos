...
This example works with data provided in ERDDAP with projected coordinates (polar stereographic). For an example of making projected maps of datasets provided in lat-lon coordinates see the projected maps exercise at: https://coastwatch.pfeg.noaa.gov/projects/r/projectedOceMaps.html 
...
[R Training Course Book](https://coastwatch.pfeg.noaa.gov/projects/r/) - Additional R notebooks for working with ERDDAP